...
#if defined(CONFIG_MACH_XIAOMI_LAVENDER) || defined(CONFIG_XIAOMI_CAMERA_MIUI_Q) ||  defined(CONFIG_XIAOMI_NEW_CAMERA_BLOBS)
...
#if defined(CONFIG_MACH_XIAOMI_SDM660) && !defined(CONFIG_XIAOMI_CAMERA_MIUI_Q)
	struct msm_vendor_id_info_t vendor_id_info;
	struct msm_vcm_id_info_t vcm_id_info;
#endif
#if defined(CONFIG_MACH_XIAOMI_LAVENDER) || defined(CONFIG_XIAOMI_NEW_CAMERA_BLOBS)
